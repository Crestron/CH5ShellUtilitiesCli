...
export class Ch5GenerateWidgetCli {
  ...
  private readonly CONFIG_FILE: any = config.generateWidget;
  ...
  public setupCommand(program: commander.Command): void {
    program
      ...
      .action(async (archive, options) => {
        try {
          await console.log("OK INSIDE Generate WIdget");
