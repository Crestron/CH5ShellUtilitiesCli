...
//     // {
//     //   const shellProjectTestCases = getAllPositiveTestCases();
//     //   for (let i = 0; i < shellProjectTestCases.length; i++) {
//     //     const caseName = "Positive Case " + i;
...
//     //   for (let i = 0; i < shellProjectTestCases.length; i++) {
//     //     const caseName = "Invalid ProjectType Case " + i;
//     //     describe('Create: ' + caseName + ": " + JSON.stringify(shellProjectTestCases[i]), function () {
...
//     // {
//     //   const shellProjectTestCases = getInvalidForceDeviceXPanelCases();
//     //   for (let i = 0; i < shellProjectTestCases.length; i++) {
//     //     const caseName = "Invalid ForceDeviceXPanel Case " + i;
//     //     describe('Create: ' + caseName + ": " + JSON.stringify(shellProjectTestCases[i]), function () {
